...
var Player = /** @class */ (function () {
    ...
    Player.prototype.newRound = function () {
        ...
        this.outOfThisRound = false;
        if (!this.isHuman()) {
            this.game.log("".concat(this.playerName, " draws their starting card."));
        }
    };
    ...
    Player.prototype.discardAndDraw = function () {
        ...
        if (!this.game.isTheDeckEmpty()) {
            this.cardOne = this.game.drawCard(this);
            this.game.log("".concat(this.playerName, " discards ").concat(cardToDiscard.getCardName(), " and draws."));
        }
        else {
            this.cardOne = this.game.drawLeftover(this);
            this.game.log("".concat(this.playerName, " discards ").concat(cardToDiscard.getCardName(), " and draws the leftover card."));
        }
    };
    Player.prototype.drawCard = function () {
        if (!this.game.isTheDeckEmpty()) {
            ...
            if (!this.isHuman()) {
                this.game.log("".concat(this.playerName, " draws a card."));
            }
        }
    };
