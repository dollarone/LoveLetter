export const colorize = new (class {
    color = (code: number, ended = false, ...messages: any[]) => `\x1b[${code}m${messages.join(" ")}${ended ? "\x1b[0m" : ""}`;
    ...
    gray = this.color.bind(this, 90, false);
    brightBlack = this.color.bind(this, 90, false);
    brightRed = this.color.bind(this, 91, false);
    brightGreen = this.color.bind(this, 92, false);
    brightYellow = this.color.bind(this, 93, false);
    brightBlue = this.color.bind(this, 94, false);
    brightMagenta = this.color.bind(this, 95, false);
    brightCyan = this.color.bind(this, 96, false);
    brightWhite = this.color.bind(this, 97, false);
